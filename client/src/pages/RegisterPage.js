    ...
    const pressHandler = async () => {
        try {
            ...
            if (password === password_check){
                await request('/api/participant/add', 'POST', { name: name, birthday: birthday, passport_series: passport_series, passport_number: passport_number, phone_number: phone_number, email: email})
